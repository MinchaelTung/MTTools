...
namespace MTFramework.WPF.Transitions
{
    ...
    public class StoryboardTransition : Transition
    {
        ...
        public static readonly DependencyProperty OldContentStyleProperty = DependencyProperty.Register("OldContentStyle", typeof(Style), typeof(StoryboardTransition), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty OldContentStoryboardProperty = DependencyProperty.Register("OldContentStoryboard", typeof(Storyboard), typeof(StoryboardTransition), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty NewContentStyleProperty = DependencyProperty.Register("NewContentStyle", typeof(Style), typeof(StoryboardTransition), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty NewContentStoryboardProperty = DependencyProperty.Register("NewContentStoryboard", typeof(Storyboard), typeof(StoryboardTransition), new UIPropertyMetadata(null));
